# Generated by Powerlevel10k configuration wizard on 2020-10-20 at 01:28 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=93
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=93
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%244F'   # green foreground
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=86
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=86
  ...
  ######################[ nnn: nnn shell (https://github.com/jarun/nnn) ]#######################
  # Nnn shell color.
  typeset -g POWERLEVEL9K_NNN_FOREGROUND=93
  # Custom icon.
  # typeset -g POWERLEVEL9K_NNN_VISUAL_IDENTIFIER_EXPANSION='⭐'

  ###########################[ vim_shell: vim shell indicator (:sh) ]###########################
  # Vim shell indicator color.
  typeset -g POWERLEVEL9K_VIM_SHELL_FOREGROUND=93
  # Custom icon.
